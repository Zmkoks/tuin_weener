...
const resultaat = huidig.map(p => {
  ...
  return {
    ...
    oogstMomenten: [
      ...(b.oogst.tijd.length || b.oogst.methode ? [{ maanden: b.oogst.tijd, wat: b.oogst.methode }] : []),
      ...(b.oogst.extraTijd.length || b.oogst.extraMethode ? [{ maanden: b.oogst.extraTijd, wat: b.oogst.extraMethode }] : []),
    ],
    oogstTijd: [...new Set([...b.oogst.tijd, ...b.oogst.extraTijd])],
    snoeiMomenten: b.snoei.tijd.length || b.snoei.tijdInfo ? [{ maanden: b.snoei.tijd, wat: b.snoei.tijdInfo }] : [],
    snoeiTijd: b.snoei.tijd, snoeiMethode: b.snoei.methode, snoeiInformatie: b.snoei.informatie,
